...
SRead.run_list("F_1Sersic_equvi_list_Bin1V.txt","F_Gal_bundle_1Sersic_equvi_Bin1V",True)
SRead.run_list("F_1Sersic_equvi_list_Bin2V.txt","F_Gal_bundle_1Sersic_equvi_Bin2V",True)
SRead.run_list("F_1Sersic_equvi_list_Bin3V.txt","F_Gal_bundle_1Sersic_equvi_Bin3V",True)
...
W2,W3,W4 = SSort.cpt_seperator_demo('F_Gal_bundle_1Sersic_equvi_Bin1V'), SSort.cpt_seperator_demo('F_Gal_bundle_1Sersic_equvi_Bin2V'),SSort.cpt_seperator_demo('F_Gal_bundle_1Sersic_equvi_Bin3V')
...
SSort.cpt_classifier_demo('F_Gal_bundle_1Sersic_equvi_Bin1V',W2,'F_Gal_bundle_1Sersic_equvi_Bin1V_cpt',[])
SSort.cpt_classifier_demo('F_Gal_bundle_1Sersic_equvi_Bin2V',W3,'F_Gal_bundle_1Sersic_equvi_Bin2V_cpt',[])
...
SRead.run_list("F_1Sersic_major_list_Bin1V.txt","F_Gal_bundle_1Sersic_major_Bin1V",False)
SRead.run_list("F_1Sersic_major_list_Bin2V.txt","F_Gal_bundle_1Sersic_major_Bin2V",False)
SRead.run_list("F_1Sersic_major_list_Bin3V.txt","F_Gal_bundle_1Sersic_major_Bin3V",False)
...
W2_m,W3_m,W4_m = SSort.cpt_seperator_demo('F_Gal_bundle_1Sersic_major_Bin1V'), SSort.cpt_seperator_demo('F_Gal_bundle_1Sersic_major_Bin2V'),SSort.cpt_seperator_demo('F_Gal_bundle_1Sersic_major_Bin3V')
...
SSort.cpt_classifier_demo('F_Gal_bundle_1Sersic_major_Bin1V',W2_m,'F_Gal_bundle_1Sersic_major_Bin1V_cpt',[])
SSort.cpt_classifier_demo('F_Gal_bundle_1Sersic_major_Bin2V',W3_m,'F_Gal_bundle_1Sersic_major_Bin2V_cpt',[])
SSort.cpt_classifier_demo('F_Gal_bundle_1Sersic_major_Bin3V',W4_m,'F_Gal_bundle_1Sersic_major_Bin3V_cpt',[])
###############
#Run all
...
SRead.run_list("F_1Sersic_major_list.txt","F_Gal_bundle_1Sersic_major_V", False)
SRead.run_list("F_1Sersic_equvi_list.txt","F_Gal_bundle_1Sersic_equvi_V", True)
...
Wm, We = SSort.cpt_seperator_demo('F_Gal_bundle_1Sersic_major_V'), SSort.cpt_seperator_demo('F_Gal_bundle_1Sersic_equvi_V')
...
SSort.cpt_classifier_demo('F_Gal_bundle_1Sersic_major_V',Wm,'F_Gal_bundle_1Sersic_major_V_cpt',[])
SSort.cpt_classifier_demo('F_Gal_bundle_1Sersic_equvi_V',We,'F_Gal_bundle_1Sersic_equvi_V_cpt',[])
...
print(len(SRead.grab_name("F_Gal_bundle_equvi_V_cpt")),
      ...
      len(SRead.grab_name("F_Gal_bundle_1Sersic_equvi_Bin1V_cpt")),
      len(SRead.grab_name("F_Gal_bundle_1Sersic_major_Bin1V_cpt")),
      len(SRead.grab_name("F_Gal_bundle_1Sersic_equvi_Bin2V_cpt")),
      len(SRead.grab_name("F_Gal_bundle_1Sersic_major_Bin2V_cpt")),
      len(SRead.grab_name("F_Gal_bundle_1Sersic_equvi_Bin3V_cpt")),
      len(SRead.grab_name("F_Gal_bundle_1Sersic_major_Bin3V_cpt")),
